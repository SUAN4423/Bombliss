...
let app = new PIXI.Application({
    width: gamewidth,                 // スクリーン(ビュー)横幅
    height: gameheight,                // スクリーン(ビュー)縦幅
...
// let normal = new PIXI.Graphics().beginFill(0x189CD6).drawRect(0, 0, blockwidthheight, blockwidthheight).endFill();
// normal.pivot.x = blockwidthheight / 2;
// normal.pivot.y = blockwidthheight / 2;
// normal.x = 100;
// normal.y = 100;
// app.stage.addChild(normal);
